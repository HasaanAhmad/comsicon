-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('MANAGER', 'TEAM_MEMBER');
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "role" "UserRole" NOT NULL DEFAULT 'TEAM_MEMBER';
...
-- CreateIndex
CREATE UNIQUE INDEX "PerformanceReview_projectId_reviewerId_subjectId_key" ON "PerformanceReview"("projectId", "reviewerId", "subjectId");

-- CreateIndex
CREATE UNIQUE INDEX "TaskAnalytics_taskId_key" ON "TaskAnalytics"("taskId");
...
-- AddForeignKey
ALTER TABLE "PerformanceReview" ADD CONSTRAINT "PerformanceReview_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
